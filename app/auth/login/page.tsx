...
import { GraduationCap, ArrowRight, Eye, EyeOff, CheckCircle2 } from "lucide-react"
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary/5 border-r border-border flex-col justify-between p-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg text-muted-foreground">
            Continue mastering your subjects with AI-powered learning tools.
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-border bg-card">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl">Sign in to Gradify</CardTitle>
              <CardDescription>
